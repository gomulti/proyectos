...
?>
  ...
  <section class="formulario" id="contacto">
    <h2 class="text-center tituloSeccion contacto" style="">Contacto</h2>
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-lg-offset-6 Contacto-DatosContacto">
          <div class="row">
            ...
            <!--<div class="col-lg-11 Contacto-TxtSolicita">
              ...
              <h4>Solicita un <br>servicio</h4>
              <p>Operamos <strong>a través de todo el país</strong>, no importa el origen o destino, <strong>somos expertos en movimiento.</strong></p>
            </div>
            ...
            <div class="col-lg-16 col-lg-offset-3 ">
                <form id="contact-form" name="contact-form" method="post" class="Contacto-Form">
                  ...
                  if (isset( $_POST['btn-submit'] )) {
                    ...
                    if ( empty( $f_empresa ) ) {
                      $reg_errors->add("empty-empresa", "El campo empresa es obligatorio");
                    }
                    //El campo Mensaje es obligatorio, comprobamos que no esté vacío y en caso contrario creamos un registro de error
                    if ( empty( $f_message ) ) {
                      $reg_errors->add("empty-message", "El campo detalle de su solicitud es obligatorio");
                    }
                    ...
                    if (count($reg_errors->get_error_messages()) == 0) {
                      ...
                      <?php }else {?>
                        <div class="alert alert-danger alert-dismissable">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                          Se ha producido un error enviando el formulario. Puede intentarlo más tarde.
                        </div>
                      <?php }?><?php
                    }
                  }?>
                      ...
                      <div class="row">
                        <div class="col-lg-12 Contacto-Col">
                          <div class="form-group">
                            <input type="text" id="f_name" name="f_name" class="form-control nombreContacto formulariomisionk" value="<?php echo $f_name;?>" placeholder="Nombre completo" required aria-required="true">
                  ...
                  <div class="row">
                    <div class="col-lg-24">
                      <div class="row">
                        <div class="col-lg-12 Contacto-Col">
                          <div class="form-group">
                            <input type="text" id="f_phone" name="f_phone" class="form-control inputEmail formulariomisionk" value="<?php echo $f_phone;?>" placeholder="Teléfono" required aria-required="true">
                            <?php //Comprobamos si hay errores en la validación del campo Nombre
                            if ( is_wp_error( $reg_errors ) ) {
                        ...
                        <div class="col-lg-12 Contacto-Col">
                          <div class="form-group">
                            <input type="text" id="f_empresa" name="f_empresa" class="form-control" value="<?php echo $f_empresa;?>" placeholder="Empresa" required aria-required="true">
                            <?php //Comprobamos si hay errores en la validación del campo Nombre
                            if ( is_wp_error( $reg_errors ) ) {
                  ...
                  <div class="row">
                    <div class="col-lg-24 col-md-24">
                      <div class="form-group">
                        <textarea id="f_message" name="f_message" rows="7" class="form-control Form-TextArea" placeholder="Detalles de su solicitud" required aria-required="true"><?php echo $f_message;?></textarea>
                  ...
                  <div class="row">
                    <div class="col-lg-24 col-md-24 text-right">
                      <button type="submit" id="btn-submit" name="btn-submit" class="btn btn-danger btnEnviar btn_vermas btnSolicitud">Enviar</button>
                    </div>
                  </div>
                </form>
            </div>
    ...
    <footer class="site-footer" role="contentinfo">
      <p>© 2017. Todos los derechos reservados. Grúas Móviles del Golfo. Diseño y desarrollo por <a href="http://gomultimedios.com/" target="_blanck">GO multimedios</a>.</p>
    </footer><!-- .site-footer -->
  </section>
