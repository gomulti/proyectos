...
<section class="slider">
  ...
  <section class="conocenos" id="equipos" style="background: url('<?php echo esc_url( home_url( '/wp-content/uploads/2017/09/' ) );?>tractocamiones-1.jpg');">
    <h2 class="text-center tituloSeccion" style="">Equipos y servicios</h2>
  ...
  <section class="nosotros" id="nosotros">
    <h2 class="text-center tituloSeccion" style="">Nosotros</h2>
    <div class="container">
      <div class="row">
        <div class="col-lg-18 col-lg-offset-3">
      ...
      <!--<h4 class="clientes">Nuestros clientes nos respaldan</h4>-->
      <div class="row">
